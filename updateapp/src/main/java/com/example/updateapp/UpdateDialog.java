...
public class UpdateDialog extends DialogFragment implements View.OnClickListener {
    ...
    private TextView tvTitle, tvNewVerName, tvDownloadStatus, tvProgress;
    ...
    private static com.example.updateapp.UpdateDialog updateDialog;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tvConfirm) {//立即更新
            if (com.example.updateapp.ViewUtil.fastDoubleClick())
                return;
     ...
     * @return
     */
    public static com.example.updateapp.UpdateDialog newInstance(Context context) {
        if (updateDialog == null) {
            synchronized ( com.example.updateapp.UpdateDialog.class) {
                if (updateDialog == null) {
                    updateDialog = new com.example.updateapp.UpdateDialog();
                }
            }
        }
        com.example.updateapp.UpdateDialog.context = context;
        return updateDialog;
    }


    public com.example.updateapp.UpdateDialog setUpdateForce(boolean isForce) {
        this.isForce = isForce;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setConfirmBgColor(int confirmBgColor) {
        this.confirmBgColor = confirmBgColor;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setCancelBgColor(int cancelBgColor) {
        this.cancelBgColor = cancelBgColor;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setConfirmBgResource(int confirmBgResource) {
        this.confirmBgResource = confirmBgResource;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setCancelBgResource(int cancelBgResource) {
        this.cancelBgResource = cancelBgResource;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setProgressDrawable(int progressDrawable) {
        this.progressDrawable = progressDrawable;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setTopResId(int topResId) {
        this.topResId = topResId;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setUpdateContent(String[] content) {
        this.content = content;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setNewVernName(String newVerName) {
        this.newVerName = newVerName;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setApkUrl(String apkUrl) {
        this.apkUrl = apkUrl;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setConfirmText(String confirmText) {
        this.confirmText = confirmText;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setTitle(String title) {
        this.title = title;
        return updateDialog;
    }

    public com.example.updateapp.UpdateDialog setCancelText(String cancelText) {
    ...
    private void initView(View view) {
        ...
        if (confirmBgColor != 0) {
            ...
            tvConfirm.setBackgroundColor(getResources().getColor(R.color.update_ok));
        }
        if (cancelBgColor != 0) {
            tvCancle.setBackgroundColor(cancelBgColor);
        }else{
            tvCancle.setBackgroundColor(getResources().getColor(R.color.update_cancel));
        }
        ...
        if (topResId != 0)
            ivTop.setBackground(getResources().getDrawable(topResId));
        if (isForce) {
    ...
    private void update() {
        if (!TextUtils.isEmpty(apkUrl)) {
            ...
            String fileName = com.example.updateapp.ApkUtil.getApkName(apkUrl);
            String directory = com.example.updateapp.ApkUtil.getApkFileDir(context);
            ...
            Kalle.Download.get(apkUrl)
                    ...
                    .perform(new Callback() {
                        ...
                        public void onFinish(String path) {
                            ...
                            com.example.updateapp.ApkUtil.installApp(context, path);
//                            if (!isForce)
                            dismiss();
                        }
     ...
     * 更新progress、请求权限
     */
    private com.example.updateapp.WeakHandler handler = new com.example.updateapp.WeakHandler(new Handler.Callback() {
        @Override
