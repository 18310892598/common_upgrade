...
public class ApkUtil {
    ...
    public static String getApkFileDir(Context context) {
        return com.example.updateapp.FileUtils.newInstance(context).getTempPath().getAbsolutePath();
    }
    ...
    public static void installApp(Context context, String apkPath) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            uri = FileProvider.getUriForFile(context, "com.example.common_upgrade.fileProvider", new File(apkPath));
        } else {
